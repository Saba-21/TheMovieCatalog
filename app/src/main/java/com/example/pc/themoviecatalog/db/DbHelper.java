...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + DbModel.MovieModel.TABLE_NAME + " (" +
                    ...
                    DbModel.MovieModel.productionCompanies + " TEXT," +
                    DbModel.MovieModel.productionCountries + " TEXT," +
    ...
    public List<MovieModel> getMovieDataToWant(){
        ...
        String[] forQuery = new String[]{
                ...
                DbModel.MovieModel.productionCompanies,
                DbModel.MovieModel.productionCountries,
        ...
        do {
            ...
            if (cursor.getCount()>0) {
                ...
                movie.productionCompanies = cursor.getString(cursor.getColumnIndex(DbModel.MovieModel.productionCompanies));
                movie.productionCountries = cursor.getString(cursor.getColumnIndex(DbModel.MovieModel.productionCountries));
    ...
    public List<MovieModel> getMovieDataToWatched(){
        ...
        Cursor cursor = db.query(DbModel.MovieModel.TABLE_NAME, forQuery,
                DbModel.MovieModel.list + " = ?", new String[]{"watched"},
                null, null, null);
    ...
    public long addMovieData(MovieModel movieData, String list) {
        ...
        contentValues.put(DbModel.MovieModel.productionCompanies, movieData.productionCompanies);
        contentValues.put(DbModel.MovieModel.productionCountries, movieData.productionCountries);
