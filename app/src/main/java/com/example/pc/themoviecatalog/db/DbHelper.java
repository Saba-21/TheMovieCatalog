...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public List<MovieModel> getMovieData(){

        List<MovieModel> movieData = new ArrayList<>();

        SQLiteDatabase db = getReadableDatabase();

        Cursor cursor = db.query(DbModel.MovieModel.TABLE_NAME,
                new String[]{
    ...
    public long addPersonData(MovieModel movieData) {
    ...
    public int deleteMovieData(int id) {
        ...
        return db.delete(DbModel.MovieModel.TABLE_NAME,
